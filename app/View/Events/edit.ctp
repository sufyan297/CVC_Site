          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  <?php
                      $img_path = $this->webroot."/files/event/image_file/".$event['Event']['image_dir']."/api_".$event['Event']['image_file'];
                  ?>
                  ...
                  <div class="form-group">
                     <?php
                       ...
                       echo $this->Form->input('Change Image', array('class' => 'btn btn-warning','type'=>'submit','label'=>false));
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      echo $this->Form->input("title",array('class'=>'form-control','label'=>false,'placeholder'=>'Enter Title','autofocus'=>true,'default'=>$event['Event']['title'], 'required'));
                    ?>
                  ...
                  <div class="form-group">
                    ...
                    <?php
                      echo $this->Form->input("description",array('type'=>'textarea','class'=>'form-control','label'=>false,'placeholder'=>'Enter Event Description','autofocus'=>true, 'default'=>$event['Event']['description'], 'required'));
                    ?>
                  </div>
                  ...
                  <div class="box-footer">
                    ...
                    <button type="submit" class="btn btn-lg btn-success btn-block">Edit Event</button>
                  </div>
                </form>
              </div><!-- /.box -->
            </div>
